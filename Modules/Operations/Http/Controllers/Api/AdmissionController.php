...
use Modules\Operations\Http\Requests\AdmissionSubmitRequest;
use Modules\Operations\Services\AdmissionService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

class AdmissionController extends \Modules\Core\Http\Controllers\Api\Controller
{
    ...
    {
        $setting = \Modules\Core\Entities\Setting::first();
