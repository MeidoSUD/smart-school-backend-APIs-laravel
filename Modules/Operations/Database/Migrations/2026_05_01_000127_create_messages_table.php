...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('messages', function (Blueprint $table) {
            ...
            $table->string('send_mail', 10)->nullable()->default(0);
            $table->string('send_sms', 10)->nullable()->default(0);
            $table->string('is_group', 10)->nullable()->default(0);
            $table->string('is_individual', 10)->nullable()->default(0);
            $table->integer('is_class')->default(0);
            $table->integer('is_schedule');
