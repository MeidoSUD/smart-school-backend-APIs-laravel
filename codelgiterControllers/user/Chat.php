...
class Chat extends Api_Controller
{
    ...
    {
        return $this->api_success(['title' => 'Chat']);
    }
    ...
    public function newMessage()
    {
        ...
        return $this->api_success(['last_insert_id' => $last_insert_id], $this->lang->line('inserted'));
    }
    ...
    public function chatUpdate()
    {
        ...
        return $this->api_success([
            'updated_chat' => $data['updated_chat'],
            'user_last_chat' => $user_last_chat
        ]);
    }
    ...
    public function mychatnotification()
    {
        ...
        return $this->api_success(['notifications' => $notifications], $this->lang->line('success_message'));
    }
    ...
    public function mynewuser()
    {
        ...
        return $this->api_success($data, $this->lang->line('success_message'));
    }
    ...
    public function adduser()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            return $this->api_error($this->lang->line('something_went_wrong'), $errors);
        } else {
