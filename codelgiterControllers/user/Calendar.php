...
class Calendar extends Api_Controller
{
    ...
    public function addtodo()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            return $this->api_success(null, $msg);
        }
    }
    ...
    public function markcomplete($id)
    {
        ...
        if (!empty($id)) {
            $this->calendar_model->saveEvent($eventdata);
            return $this->api_success(null, $this->lang->line('mark_completed_successfully'));
        } else {
            return $this->api_error($this->lang->line('cannot_mark_complete_this_event'));
        }
    }
    ...
    public function delete_event($id)
    {
        if (!empty($id)) {
            ...
            return $this->api_success(null, $this->lang->line('delete_message'));
        } else {
            return $this->api_error($this->lang->line('cannot_delete_this_event'));
        }
    }
}
