...
class Homework extends Api_Controller
{
    ...
    public function download($id)
    {
        ...
        return $this->api_success(['document' => $homework['document']]);
    }
    ...
    public function assigmnetDownload($id)
    {
        ...
        if (!empty($homeworkdocs)) {
            ...
            return $this->api_success(['document' => $homeworkdocs[0]['docs']]);
        }
    ...
    public function createdailyassignment()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            return $this->api_success(['id' => $id], $this->lang->line('success_message'));
        }
    }
