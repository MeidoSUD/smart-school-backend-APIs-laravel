...
class Syllabus extends Api_Controller
{
    ...
    public function download($id)
    {
        ...
        return $this->api_success(['attachment' => $result->attachment]);
    }
    ...
    public function lacture_video_download($id)
    {
        ...
        return $this->api_success(['video' => $result->lacture_video]);
    }
    ...
    public function deletemessage()
    {
        ...
        return $this->api_success(null, 'Message deleted successfully');
    }
}
