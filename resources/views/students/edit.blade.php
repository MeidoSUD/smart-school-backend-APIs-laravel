    ...
    <form action="{{ route('admin.students.update', $student->id) }}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-12">
                ...
                <textarea name="student_address" class="form-control" rows="2">{{ old('student_address', $student->student_address) }}</textarea>
            </div>
            <div class="col-md-4">
                <label class="form-label">Status</label>
                <select name="is_active" class="form-select">
                    <option value="active" {{ old('is_active', $student->is_active) == 'active' ? 'selected' : '' }}>Active</option>
                    <option value="inactive" {{ old('is_active', $student->is_active) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                </select>
            </div>
        </div>
        <div class="mt-4">
