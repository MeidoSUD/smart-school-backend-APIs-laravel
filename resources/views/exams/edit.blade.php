    ...
    <form action="{{ route('admin.exams.update', $exam->id) }}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="note" class="form-control" value="{{ old('note', $exam->note) }}">
            </div>
            <div class="col-md-4">
        ...
        <div class="mt-4">
            <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>Update Exam</button>
        </div>
    </form>
</div>
@endsection
