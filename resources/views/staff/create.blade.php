    ...
    <form action="{{ route('admin.staff.store') }}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <select name="staff_designation_id" class="form-select">
                    ...
                    @foreach($designations as $desig)
                        <option value="{{ $desig->id }}" {{ old('staff_designation_id') == $desig->id ? 'selected' : '' }}>{{ $desig->staff_designation_name }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="employee_salary" class="form-control" value="{{ old('employee_salary') }}" step="0.01">
            </div>
            <div class="col-md-6">
        ...
        <div class="mt-4">
            <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>Save Staff</button>
        </div>
    </form>
</div>
@endsection
