    ...
    <form action="{{ route('admin.hostels.store') }}" method="POST">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <input type="text" name="hostel_name" class="form-control" value="{{ old('hostel_name') }}" required>
            </div>
            <div class="col-md-6">
        ...
        <div class="mt-4">
            <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>Save Hostel</button>
        </div>
    </form>
</div>
@endsection
